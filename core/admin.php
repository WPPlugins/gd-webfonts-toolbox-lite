...
class gdwft_admin_core {
    ...
    function upgrade_notice() {
        if (gdwft_settings()->get('upgrade_to_pro_120') == 1 && !gdwft_settings()->is_install()) {
            ...
            echo '<div class="updated d4p-updated">';
                ...
                echo '<strong><a href="https://pack.dev4press.com/" target="_blank">'.__("Dev4Press Plugins Pack", "gd-webfonts-toolbox-lite")."</a></strong> | ";
    ...
    public function admin_init() {
        ...
        if (isset($_GET['proupgradewft']) && $_GET['proupgradewft'] == 'hide') {
            gdwft_settings()->set('upgrade_to_pro_120', 0);
            gdwft_settings()->save();
    ...
    public function enqueue_scripts($hook) {
        if ($this->page !== false) {
            ...
            $depend_js = array('d4plib-admin', 'wpdialogs', 'jquery-ui-sortable');
            ...
            wp_enqueue_style('fontawesome', GDWFT_URL.'d4plib/resources/fontawesome/css/font-awesome.min.css');
            ...
            wp_localize_script('d4plib-shared', 'd4plib_admin_data', array(
                'string_media_image_title' => __("Select Image", "gd-webfonts-toolbox-lite"),
                'string_media_image_button' => __("Use Selected Image", "gd-webfonts-toolbox-lite"),
                'string_are_you_sure' => __("Are you sure you want to do this?", "gd-webfonts-toolbox-lite"),
                'string_image_not_selected' => __("Image not selected.", "gd-webfonts-toolbox-lite")
            ));
        }
    }
