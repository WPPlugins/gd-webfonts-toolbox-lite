...
<div class="<?php echo join(' ', $_classes); ?>">
    ...
    <div class="d4p-content">
        ...
        <div class="d4p-content-right">
            ...
            <h3 style="margin-top: 0;"><?php _e("All Done", "gd-webfonts-toolbox-lite"); ?></h3>
            <?php
            ...
            <h3 style="margin: 20px 0;"><?php _e("Important Notice", "gd-webfonts-toolbox-lite"); ?></h3>
            <?php _e("Before you can use the plugin, clear the website and browser cache to make sure that latest JS and CSS files are loaded.", "gd-webfonts-toolbox-lite"); ?>
        </div>
    </div>
</div>